...
namespace TestBooster24GroupApp.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //Doctor registration
        [AllowAnonymous]
        public ActionResult RegisterGroup()
        {
            var viewModel = new TestBoosetr24GroupViewModel();           
            return View("TestBooster24GroupForm", viewModel);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public  async Task<ActionResult> RegisterGroup(TestBoosetr24GroupViewModel viewModel)
        {
            if (ModelState.IsValid)
            {
                TestBoosetr24Group group = new TestBoosetr24Group()
                {
                    Name = viewModel.Name,
                    Address = viewModel.Address,
                ...
                _unitOfWork.TestBoosetr24Groups.Add(group);
                _unitOfWork.Complete();
