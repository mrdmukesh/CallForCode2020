    ...
    public partial class InitialDb : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.TestBoosetr24Group", t => t.TestGroups_Id)
                .Index(t => t.CityId)
                .Index(t => t.TestGroups_Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Patients", "TestGroups_Id", "dbo.TestBoosetr24Group");
            ...
            DropIndex("dbo.Patients", new[] { "TestGroups_Id" });
