    ...
    public class PatientsController : Controller
    {
        ...
        public ActionResult Create()
        {
            var viewModel = new PatientFormViewModel
            {
                ...
                TestGroups = _unitOfWork.TestBoosetr24Groups.GetTestBoosetr24Groups(),
                Heading = "New Patient"
            };
        ...
        public ActionResult Create(PatientFormViewModel viewModel)
        {
            if (!ModelState.IsValid)
            {
                ...
                viewModel.TestGroups = _unitOfWork.TestBoosetr24Groups.GetTestBoosetr24Groups();
                return View("PatientForm", viewModel);
            ...
            var patient = new Patient
            {
                ...
                TestGId =  viewModel.TestGroup,
                Sex = viewModel.Sex,
                Token = (2020 + _unitOfWork.Patients.GetPatients().Count()).ToString().PadLeft(7, '0')
            };
        ...
        public ActionResult Update(PatientFormViewModel viewModel)
        {
            ...
            patientInDb.TestGroups = patientInDb.TestGroups;
            patientInDb.Sex = viewModel.Sex;
            patientInDb.CityId = viewModel.City;
            patientInDb.TestGId = viewModel.TestGroup;
